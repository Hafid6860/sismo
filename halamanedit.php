    ...
    <div class="container mt-5">
        ...
        <form action="prosesedit.php" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="nopol" name="nopol" value="<?= $data['nopol']; ?>" required>
            </div>

            <div class="mb-3">
                <label for="type_motor" class="form-label">Type Motor:</label>
                <input type="text" class="form-control" id="type_motor" name="type_motor" value="<?= $data['type_motor']; ?>" required>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="keluhan" name="keluhan" value="<?= $data['keluhan']; ?>" required>
            </div>
